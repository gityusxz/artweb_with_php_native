...
//eksekusi query
$idd = $_GET['id'];
$query = mysqli_query($konek, "SELECT * FROM kategori WHERE id = $idd");
            ...
            <div class="col-md-10 mt-3">
                <div class="card">
                    ...
                    foreach ($query as $data) { ?>
                        ...
                        <div class="card-body">
                            <form method="POST" action="proses_edt_kt.php">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Kategori</label>
                                    <input value="<?= $data['kategori'] ?>" type="text" name="kt" class="form-control" id="exampleInputEmail1" placeholder="masukkan kategori">
